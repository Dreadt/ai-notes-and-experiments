...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train MNIST with Lightning on a single GPU.")
    ...
    parser.add_argument("--save-dir", type=str, default="./checkpoints_single", help="Checkpoint directory.")
...
def main() -> None:
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath=save_dir,
        filename="best-single-{epoch:02d}-{val_acc:.4f}",
        monitor="val_acc",
        mode="max",
        save_top_k=1,
    )
