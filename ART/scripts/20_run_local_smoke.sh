...
export ART_BASE_MODEL="${ART_BASE_MODEL:-Qwen/Qwen3-0.6B}"
export ART_MAX_STEPS="${ART_MAX_STEPS:-2}"
export ART_ROLLOUTS_PER_SCENARIO="${ART_ROLLOUTS_PER_SCENARIO:-8}"
export ART_MAX_TOKENS="${ART_MAX_TOKENS:-24}"
export ART_ROLLOUT_TEMPERATURE="${ART_ROLLOUT_TEMPERATURE:-1.1}"
export ART_EVAL_TEMPERATURE="${ART_EVAL_TEMPERATURE:-0.3}"
export ART_MIN_BATCH_SIZE="${ART_MIN_BATCH_SIZE:-2}"
export ART_DISCARD_QUEUE_MULTIPLIER="${ART_DISCARD_QUEUE_MULTIPLIER:-500}"
...
cd "${ROOT_DIR}"
"${PYTHON_BIN}" art_experiment/local_smoke.py
