...
DATASET_PATH="${DATASET_PATH:-${ROOT_DIR}/data/countdown_sample_1024.jsonl}"
PLUGIN_PATH="${ROOT_DIR}/plugins/countdown_plugin.py"
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT_DIR}/outputs/countdown_colocate_2gpu_1p7b_1k/v0-20260718-133335}"
CHECKPOINT_PATH="${CHECKPOINT_PATH:-${OUTPUT_DIR}/checkpoint-160}"
